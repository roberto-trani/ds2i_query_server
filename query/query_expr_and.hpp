#ifndef INDEX_PARTITIONING_QUERY_AND_EXPR_HPP
#define INDEX_PARTITIONING_QUERY_AND_EXPR_HPP
...
template<typename T>
std::ostream &
operator<<(std::ostream &os, const query::QueryExprAND<T> &ref) {
...
#endif //INDEX_PARTITIONING_QUERY_AND_EXPR_HPP
